...
### Cleaning EIS file on 05232024

cleaning_05232024_files <- function(user_name) {   
  ...
  folder_struct <-
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\20240523_9_PEGMEA_1_PEGDA_5_Aerosil380_0to20_NaTFSI_400ppm_Inhibitor')
  ...
  new_files <- orig_files |>
    dplyr::mutate(
      ...
      new_filename = stringr::str_replace(new_filename, '/05232024_D4_RUN4/', '/'),
  ...
  readr::write_csv(
    new_files,
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr files\\data_dictionary\\20240523_9_PEGMEA_1_PEGDA_5_Aerosil380_0to20_NaTFSI_400ppm_Inhibitor_database_dictionary.csv)')
  )
  return(new_files)
}

cleaning_05232024_files(user_name)

rm(cleaning_05232024_files)
