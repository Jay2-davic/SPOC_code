...
### Cleaning EIS file on 10172023

cleaning_10172023_files <- function(user_name) {
  suppressMessages({
    suppressWarnings({
      ...
      folder_struct <-
        glue::glue(
          'C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr files\\10172023 9pegmea 1 pegda 7.5 aerosil 380 constant 22.5 Litfsi Change'
        )
      ...
      readr::write_csv(
        new_files,
        glue::glue(
          'C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr files\\data_dictionary\\10172023 9pegmea 1 pegda 7.5 aerosil 380 constant 22.5 Litfsi Change_database_dictionary.csv'
        )
      )
...
cleaning_10172023_files(user_name)
rm(cleaning_10172023_files)