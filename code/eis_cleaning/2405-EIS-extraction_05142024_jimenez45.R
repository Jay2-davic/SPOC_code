...
### Cleaning EIS file on 05142024

cleaning_05142024_files <- function(user_name) {   
  ...
  folder_struct <-
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\EIS_Silverman1\\05142024_NaTFSI_10_AE380_0to10')
  ...
  readr::write_csv(
    new_files,
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr files\\data_dictionary\\05142024_NaTFSI_10_AE380_0to10_database_dictionary.csv)')
  )
  return(new_files)
}

cleaning_05142024_files(user_name)

rm(cleaning_05142024_files)
