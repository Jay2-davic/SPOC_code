...
### Cleaning EIS file on 08082024

cleaning_08082024_files <- function(user_name) {   
  ...
  folder_struct <-
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\20240808_9_PEGMEA_1_PEGDA_7p5_Aerosil380_0to30_LiTFSI_100ppm_Inhibitor')
  ...
  new_files <- orig_files |>
    dplyr::mutate(
      ...
      wt_salt_max_1 = 30,
      wt_salt_max_2 = 0,
      wt_additive_max_1 = 7.5,
      wt_additive_max_2 = 7.5,
  ...
  readr::write_csv(
    new_files,
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr files\\data_dictionary\\20240808_9_PEGMEA_1_PEGDA_0_Aerosil380_0to30_LiTFSI_100ppm_Inhibitor_database_dictionary.csv)')
  )
  return(new_files)
}

cleaning_08082024_files(user_name)

rm(cleaning_08082024_files)
