...
### Cleaning EIS file on 08012024

cleaning_08012024_files <- function(user_name) {   
  ...
  folder_struct <-
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\20240801_Retest_9_PEGMEA_1_PEGDA_0_Aerosil380_0to30_LiTFSI_100ppm_Inhibitor')
  ...
  new_files <- orig_files |>
    dplyr::mutate(
      ...
      new_filename = stringr::str_replace(new_filename, '07222024', '08012024'),
  ...
  readr::write_csv(
    new_files,
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr files\\data_dictionary\\20240801_Retest_9_PEGMEA_1_PEGDA_0_Aerosil380_0to30_LiTFSI_100ppm_Inhibitor_database_dictionary.csv)')
  )
  return(new_files)
}

cleaning_08012024_files(user_name)

rm(cleaning_08012024_files)
