...
def EIS_CycleSplitter(EIS_file, output_path):
    ...
    filename = rf'{output_file_dir}\{filename}'
...
def EIS_conversion(database_path):
    '''
    ...
    #database_csv = r'C:\Users\jimenez45\OneDrive - LLNL\General - High-Throughput Polymer Electrolytes DIW\database_dictionary.csv'
