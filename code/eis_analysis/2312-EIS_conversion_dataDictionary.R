...
conversion_dataDictionary <- function() {
  ...
  # loads renamed mpr files
  new_files <- glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr_new_names')
  ...
  # loads the results fromt the finished files
  conv_files <- glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr_new_files_converted')
  ...
  readr::write_csv(
    df,
    glue::glue(
      'C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\database_conversion_dictionary.csv')
  )
}
