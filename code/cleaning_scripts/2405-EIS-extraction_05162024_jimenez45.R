...
### Cleaning EIS file on 05162024

cleaning_05162024_files <- function(user_name) {   
  ...
  folder_struct <-
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\EIS_Silverman1\\05162024_NaTFSI_0to20_AE380_5')
  ...
  readr::write_csv(
    new_files,
    glue::glue('C:\\Users\\{user_name}\\OneDrive - LLNL\\General - High-Throughput Polymer Electrolytes DIW\\Database of polymer electrolytes\\mpr files\\data_dictionary\\05162024_NaTFSI_0to20_AE380_5_database_dictionary.csv')
  )
  return(new_files)
}

cleaning_05162024_files(user_name)

rm(cleaning_05162024_files)
